...
const Signup = ({setShow, show}) => {
  ...
  {
    loading ? <div className="fixed top-0 left-0 z-50 w-screen h-screen flex items-center justify-center">
          <ReactLoading type={'spin'} color={'#fff'} height={50} width={50} />
        </div> : ( <div className="flex flex-col  dark:text-gray-300 text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
